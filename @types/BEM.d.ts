...
// BEM<"btn", ["price", "recommend"], ["small", "medium"]> = "btn__price--small" | "btn__price--medium" | "btn__recommend--small" | "btn__recommend--medium"
...
> = E["length"] extends 0
  ...
  : {
      [KeyElement in E[number]]: {
        [KeyModifier in M[number]]: `${B}__${KeyElement}--${KeyModifier}`;
      }[M[number]];
    }[E[number]];
